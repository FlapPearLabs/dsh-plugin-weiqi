...
| Baseline ID | Capability | Spec Target | Current Evidence | Current State | Gap | Wave | Recommended Handling |
|---|---|---|---|---|---|---|---|
| BL-GR-01 | GoRulesPort interface | Spec §26 `createGame/play/pass/getState/inspectGroup/score/settle` | Absent from `src/contracts` | NOT_IMPLEMENTED | Interface + implementation | B | IMPLEMENTATION_TICKET |
...
| BL-GR-06 | Canonical action log / replay | Spec §28 canonical record | No `CanonicalGameRecord`/`GameAction` types | NOT_IMPLEMENTED | Record schema + replay | B | IMPLEMENTATION_TICKET |
| BL-GR-07 | Deterministic fixtures | Spec §31 ten cases | No fixtures | NOT_IMPLEMENTED | Fixture suite with GoRulesPort | B | IMPLEMENTATION_TICKET |
...
| BL-UI-02 | Production Harness Go UI | Spec §32/§33 full Go view in Harness Web | No production code; no view extension | NOT_IMPLEMENTED | Full UI implementation (Goban, seats, controls, Work peripheral, board click, sound) | E | IMPLEMENTATION_TICKET (blocked by BL-UI-04) |
...
| Baseline ID | Capability | Spec Target | Current Evidence | Current State | Gap | Wave | Recommended Handling |
|---|---|---|---|---|---|---|---|
| BL-HARD-01 | Crash / resume (dual session + canonical record + CompanionState) | Spec §36 | No code | NOT_IMPLEMENTED | Recovery pipeline | F | IMPLEMENTATION_TICKET |
| BL-HARD-02 | Replay recovery | Spec §28/§36 | No code | NOT_IMPLEMENTED | Depends on BL-GR-06 | F | IMPLEMENTATION_TICKET |
