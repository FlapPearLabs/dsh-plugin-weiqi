...
**Status:** ARCHITECTURE FROZEN — R2.4 / COOPERATIVE_YIELD_VERIFIED / READY FOR BUILD PHASE A  
...
Candidate V0.1 model-facing tools:
...
replay canonical actions
        ↓
verify resulting authoritative state
```

This keeps persistence independent from Tenuki internal object layout.
